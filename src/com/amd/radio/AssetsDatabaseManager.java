...
public class AssetsDatabaseManager {
	...
	public SQLiteDatabase getDatabase(String dbfile) {
		if(databases.get(dbfile) != null){
			DebugLog.i(tag, String.format("Return a database copy of %s", dbfile));
			return (SQLiteDatabase) databases.get(dbfile);
		}
		if(context==null)
			return null;
		
		DebugLog.i(tag, String.format("Create database %s", dbfile));
		...
		if(!flag || !file.exists()){
			...
			if(!file.exists() && !file.mkdirs()){
				DebugLog.i(tag, "Create \""+spath+"\" fail!");
				return null;
			}
			if(!copyAssetsToFilesystem(dbfile, sfile)){
				DebugLog.i(tag, String.format("Copy %s to %s fail!", dbfile, sfile));
				return null;
			}
	...
	private boolean copyAssetsToFilesystem(String assetsSrc, String des){
		DebugLog.i(tag, "Copy "+assetsSrc+" to "+des);
	...
	static public void closeAllDatabase(){
		DebugLog.i(tag, "closeAllDatabase");
		if(mInstance != null){
